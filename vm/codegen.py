...
class _VM3:
    ...
    def _v1(self, o, ops, lbl, a, b, tmp, _enc=0, _bk=0):
        ...
        if o==0x26:
            _a=rv(0); _b=rv(1); self._guard_binary_operands(o, _a, _b)
            try: self._s1(d, _a**_b)
            except: self._s1(d, 0)
            return
        if o==0x28: _a=rv(0); self._guard_unary_operand(o, _a); self._s1(d, -_a); return
        ...
        if o==0x30: _a=rv(0); self._guard_unary_operand(o, _a); self._s1(d, ~_a); return
        ...
        if o==0x3A: _a=rv(0); self._guard_unary_operand(o, _a); self._s1(d, not _a); return
    ...
    def _v2(self, o, ops, lbl, a, b, tmp, _enc=0, _bk=0):
        ...
        if o==0x27:
            _a=rv(0); _b=rv(1); self._guard_binary_operands(o, _a, _b)
            try: self._s2(s(2), _a**_b)
            except: self._s2(s(2), 0)
            return
        if o==0x29: _a=rv(0); self._guard_unary_operand(o, _a); self._s2(s(1), -_a); return
        ...
        if o==0x31: _a=rv(0); self._guard_unary_operand(o, _a); self._s2(s(1), ~_a); return
        ...
        if o==0x3B: _a=rv(0); self._guard_unary_operand(o, _a); self._s2(s(1), not _a); return
    ...
    @staticmethod
    def _guard_unary_operand(op, a):
        if a is None:
            raise RuntimeError(f"Operand resolution failure: op={op}, a={a}")
